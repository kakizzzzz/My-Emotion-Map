...
Account/password auth, revisioned sync, photo assistance, grounded chat and
MCP access are implemented through the dedicated My Emotion Map Supabase
project. My Life Memory is never modified. Its read-only
